...
5. **Отчёт по практике**
   - Составьте отчёт по проектной (учебной) практике на основании шаблона (структуры), размещённого в папке reports. Шаблон (структура) приведён в файле [reports/practice_report_template.docx](https://github.com/mospol/practice-2025-1/blob/master/reports/practice_report_template.docx).
...
В рамках практики следует придерживаться заданной структуры git-репозитория, приведённой в файле [git_structure.md](https://github.com/mospol/practice-2025-1/blob/master/task/git_structure.md).

---

### Контрольные сроки

Сроки контрольных мероприятий приведены в файле [terms.md](https://github.com/mospol/practice-2025-1/blob/master/task/terms.md).
